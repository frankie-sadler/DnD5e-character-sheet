                  ...
                  <ul>
                    <li>
                      <label for="Acrobatics">
                        Acrobatics <span class="skill">(Dex)</span>
                      </label>
                    ...
                    <li>
                      <label for="Animal Handling">
                        Animal Handling <span class="skill">(Wis)</span>
                      </label>
                      <input
                    ...
                    <li>
                      <label for="Arcana">
                        Arcana <span class="skill">(Int)</span>
                      </label>
                    ...
                    <li>
                      <label for="Athletics">
                        Athletics <span class="skill">(Str)</span>
                      </label>
                    ...
                    <li>
                      <label for="Deception">
                        Deception <span class="skill">(Cha)</span>
                      </label>
                    ...
                    <li>
                      <label for="History">
                        History <span class="skill">(Int)</span>
                      </label>
                    ...
                    <li>
                      <label for="Insight">
                        Insight <span class="skill">(Wis)</span>
                      </label>
                    ...
                    <li>
                      <label for="Intimidation">
                        Intimidation <span class="skill">(Cha)</span>
                      </label>
                    ...
                    <li>
                      <label for="Investigation">
                        Investigation <span class="skill">(Int)</span>
                      </label>
                      <input
                        name="Investigation"
                        placeholder="+0"
                    ...
                    <li>
                      <label for="Medicine">
                        Medicine <span class="skill">(Wis)</span>
                      </label>
                    ...
                    <li>
                      <label for="Nature">
                        Nature <span class="skill">(Int)</span>
                      </label>
                    ...
                    <li>
                      <label for="Perception">
                        Perception <span class="skill">(Wis)</span>
                      </label>
                    ...
                    <li>
                      <label for="Performance">
                        Performance <span class="skill">(Cha)</span>
                      </label>
                    ...
                    <li>
                      <label for="Persuasion">
                        Persuasion <span class="skill">(Cha)</span>
                      </label>
                    ...
                    <li>
                      <label for="Religion">
                        Religion <span class="skill">(Int)</span>
                      </label>
                    ...
                    <li>
                      <label for="Sleight of Hand">
                        Sleight of Hand <span class="skill">(Dex)</span>
                      </label>
                      <input
                    ...
                    <li>
                      <label for="Stealth">
                        Stealth <span class="skill">(Dex)</span>
                      </label>
                    ...
                    <li>
                      <label for="Survival">
                        Survival <span class="skill">(Wis)</span>
                      </label>
